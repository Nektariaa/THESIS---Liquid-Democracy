...
int main ()
{
	...
	int noig=70; //num of gurus	10% of 20 voters
	int missinformed=130;//EPELEKSE TO PLITHOS TWN MISSINFORMED-------------------------------------------------------------------------!-!-!-!-!
...
//read small world network from file
    ifstream file("WS 500-12-0.125.txt");
...
//Parallel descending sortment of S (gaussian_dis_nums) and guru (set of gurus)
	...
	float mo=0;
	mo=(psif_del + psif_dir)/1000;
	
	
	cout<<"The Average Accuracy Value with witch the truth is elected: ";
	cout<<mo;
